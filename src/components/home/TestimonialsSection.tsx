...
const testimonials = [
  { name: "Rajesh S.", company: "E-Commerce Brand, Delhi", quote: "All India Marketing Solution took our organic traffic from 2K to 19K monthly visitors in 11 months. The ROI on their SEO work alone paid for a year of services.", metric: "+847%", metricLabel: "Organic Traffic" },
