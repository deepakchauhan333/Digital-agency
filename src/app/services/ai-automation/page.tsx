...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.allindiamarketingsolution.com/services/ai-automation" },
  keywords: [
  ...
  openGraph: {
    title: "AI Automation — CRM, Chatbots, Workflows | All India Marketing Solution",
    description: "AI chatbots, CRM automation, workflow optimization. Avg 30 hrs/week saved. Custom AI solutions.",
    url: "https://www.allindiamarketingsolution.com/services/ai-automation",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "All India Marketing Solution AI Automation Services" }],
  },
};
