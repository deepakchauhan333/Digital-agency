...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Automation — CRM, Chatbots, Workflows | Growthpedia",
    description: "AI chatbots, CRM automation, workflow optimization. Avg 30 hrs/week saved. Custom AI solutions.",
    url: "https://growthpedia.in/services/ai-automation",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Growthpedia AI Automation Services" }],
  },
};
