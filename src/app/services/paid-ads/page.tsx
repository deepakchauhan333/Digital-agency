...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Paid Ads Agency — Google, Meta, LinkedIn Ads | Growthpedia",
    description: "PPC management with avg 4.2x ROAS. Google Ads, Meta Ads, LinkedIn, YouTube. ₹100Cr+ managed.",
    url: "https://growthpedia.in/services/paid-ads",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Growthpedia Paid Ads — PPC & Performance Marketing Agency" }],
  },
};
