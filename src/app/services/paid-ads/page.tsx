...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.digitalgrowpedia.com/services/paid-ads" },
  keywords: [
  ...
  openGraph: {
    title: "Paid Ads Agency — Google, Meta, LinkedIn Ads | DigitalGrowPedia",
    description: "PPC management with avg 4.2x ROAS. Google Ads, Meta Ads, LinkedIn, YouTube. ₹100Cr+ managed.",
    url: "https://www.digitalgrowpedia.com/services/paid-ads",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "DigitalGrowPedia Paid Ads — PPC & Performance Marketing Agency" }],
  },
};
