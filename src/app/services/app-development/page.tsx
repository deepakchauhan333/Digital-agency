...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.digitalgrowpedia.com/services/app-development" },
  keywords: [
  ...
  openGraph: {
    title: "App Development — iOS, Android, Cross-Platform | DigitalGrowPedia",
    description: "iOS, Android, React Native, Flutter. MVP to enterprise. 50K+ downloads. 4.5+ ratings.",
    url: "https://www.digitalgrowpedia.com/services/app-development",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "DigitalGrowPedia App Development Services" }],
  },
};
