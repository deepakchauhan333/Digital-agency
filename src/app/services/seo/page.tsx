...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "SEO Services — Grow Organic Traffic 3-8x | Growthpedia Agency",
    ...
    url: "https://growthpedia.in/services/seo",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Growthpedia SEO Services — Search Engine Optimization Agency India" }],
  },
  twitter: {
