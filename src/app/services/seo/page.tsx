...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.allindiamarketingsolution.com/services/seo" },
  keywords: [
  ...
  openGraph: {
    title: "SEO Services — Grow Organic Traffic 3-8x | All India Marketing Solution",
    ...
    url: "https://www.allindiamarketingsolution.com/services/seo",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "All India Marketing Solution SEO Services — Search Engine Optimization Agency India" }],
  },
  twitter: {
