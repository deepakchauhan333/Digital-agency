...
import { appDevelopmentServices, appDevelopmentCombos } from '@/data/app-development-pricing';

export const metadata = {
  title: 'Mobile App Development Packages 2026 | DigitalGrowPedia',
  description: 'Custom iOS and Android App Development pricing in India. We build crash-free, scalable apps for startups and enterprises.',
};
    ...
    <div className={styles.pageContainer}>
      <section className={styles.heroSection}>
        <div className="container">
          <div className="section-label">Mobile App Development</div>
          <h1 className="mb-4">Custom Android & iOS<br />App Development Cost</h1>
      ...
      <div className="container">
        <div className={styles.contentWrapper}>
          ...
          <aside className={styles.sidebar}>
            ...
            {appDevelopmentServices.map((service, idx) => (
          ...
          <main>
            ...
            <section id="combos" className={styles.serviceSection}>
              ...
              <div className={styles.comboGrid}>
                {appDevelopmentCombos.map((combo, idx) => (
      ...
      <section className={styles.footerSection}>
        <div className="container">
          <h2 className="mb-4">Bring Your App Idea to Life</h2>
          <p className="mx-auto mb-8" style={{ maxWidth: '650px' }}>
            Book a free technical consultation with our lead engineers today to map out the best architecture and cost approach for your startup.
          </p>
          ...
          <a href="mailto:allindiamarketingsolution1@gmail.com" className="btn btn-primary" style={{ padding: '20px 40px', fontSize: '18px' }}>
            Schedule a Free Tech Audit Now
          </a>
        </div>
      </section>
    </div>
