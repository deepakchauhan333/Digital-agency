...
import { aiAutomationServices, aiAutomationCombos } from '@/data/ai-automation-pricing';

export const metadata = {
  title: 'AI Automation & CRM Packages 2026 | DigitalGrowPedia',
  description: 'AI chatbots, automated WhatsApp replies, and CRM data sync setups in India. Save hours of manual employee labor with our custom automations.',
};

export default function AiAutomationPricingPage() {
  return (
    <div className={styles.pageContainer}>
      <section className={styles.heroSection}>
        <div className="container">
          <div className="section-label">AI & Workflow Automation</div>
          <h1 className="mb-4">AI Chatbots & Business<br />Automation Cost</h1>
          <p className="mx-auto" style={{ maxWidth: '700px', margin: '0 auto', fontSize: '18px', textAlign: 'center' }}>
            We replace manual data entry with custom scripts. Get automated WhatsApp replies, instant CRM syncing, and intelligent AI chatbots to scale your business without hiring more staff.
          </p>
        </div>
      </section>
      ...
      <div className="container">
        <div className={styles.contentWrapper}>
          ...
          <aside className={styles.sidebar}>
            ...
            {aiAutomationServices.map((service, idx) => (
              ...
              <div className={styles.serviceHeader}>
                ...
                <div>
                  <h2 style={{ background: 'linear-gradient(135deg, var(--secondary), var(--secondary-dim))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    Complete Automation Packs
                  </h2>
                  <p style={{ marginTop: '8px', color: 'var(--on-surface-variant)' }}>
                    Save money by buying our proven workflows instead of building from scratch.
                  </p>
                </div>
              </div>

              <div className={styles.comboGrid}>
                {aiAutomationCombos.map((combo, idx) => (
      ...
      <section className={styles.footerSection}>
        <div className="container">
          <h2 className="mb-4">Ready to Automate Your Work?</h2>
          <p className="mx-auto mb-8" style={{ maxWidth: '650px' }}>
            Book a free audit. We will look at your current manual processes and tell you exactly which ones can be automated using AI.
          </p>
