...
import { graphicDesignServices, graphicDesignCombos } from '@/data/graphic-design-pricing';

export const metadata = {
  title: 'Graphic Design & Branding Packages 2026 | DigitalGrowPedia',
  description: 'Premium branding and graphic design retainers in India. We design logos, print assets, pitch decks, and daily social media graphics.',
};

export default function GraphicDesignPricingPage() {
  return (
    <div className={styles.pageContainer}>
      <section className={styles.heroSection}>
        <div className="container">
          <div className="section-label">Branding & Creative Design</div>
          <h1 className="mb-4">Premium Graphic Design &<br />Company Branding Cost</h1>
          <p className="mx-auto" style={{ maxWidth: '700px', margin: '0 auto', fontSize: '18px', textAlign: 'center' }}>
            A cheap logo costs you customer trust. We build premium, memorable brand identities and social graphics that make your business look like an industry leader.
          </p>
        </div>
      </section>
              ...
              <div className={styles.serviceHeader}>
                ...
                <div>
                  <h2 style={{ background: 'linear-gradient(135deg, var(--secondary), var(--secondary-dim))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    Complete Creative Bundles
                  </h2>
                  <p style={{ marginTop: '8px', color: 'var(--on-surface-variant)' }}>
                    Save time and money by hiring us as your dedicated outsourced design team.
                  </p>
                </div>
              </div>

              <div className={styles.comboGrid}>
                {graphicDesignCombos.map((combo, idx) => (
      ...
      <section className={styles.footerSection}>
        <div className="container">
          <h2 className="mb-4">Ready for a Visual Facelift?</h2>
          <p className="mx-auto mb-8" style={{ maxWidth: '650px' }}>
            Whether you need a one-time logo or a full-time design partner, we are ready to elevate your brand.
          </p>
